...
\icmltitlerunning{NEXUS: Bit-Exact ANN-to-SNN Equivalence via Neuromorphic Gate Circuits}
...
\twocolumn[
  \icmltitle{NEXUS: Bit-Exact ANN-to-SNN Equivalence via Neuromorphic Gate Circuits \\ with Surrogate-Free Training}
  ...
  \icmlaffiliation{bu}{Department of Computer Science, Boston University, Boston, MA, USA}
  ...
  % paper; these are used to populate the "keywords" metadata in the PDF but
  % will not be shown in the document
  \icmlkeywords{Spiking Neural Networks, Machine Learning, ICML}
...
\input{section/02relatedwork}
\input{section/03methods}
\input{section/04experiment}
\input{section/05conclusion}
